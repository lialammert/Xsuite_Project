...
line_b2.insert_element(element=monitor_2, name='m2', index=0)
...
file_name = f'/afs/cern.ch/work/l/llammert/public/xsuite_project/outputs/IP1/{folder}/{name_coupling}_{name_sep}_{name_bb}.pkl' #changed path
